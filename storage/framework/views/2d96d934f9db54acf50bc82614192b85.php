...
<div class="container mt-4" style="max-width: 820px;">
    <h4>About Us</h4>
    <p><?php echo e($cms['settings']['about_us'] ?? 'We are a modern educational institution committed to academic excellence, character building, and community engagement. Our campus combines experienced teachers, digital classrooms, and a complete school management platform connecting administrators, teachers, students, and parents.'); ?></p>
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\school-mgt\resources\views/front/about.blade.php ENDPATH**/ ?>